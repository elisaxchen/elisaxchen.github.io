...
1. <span class="research-strand">AI in Education in Developing Contexts:</span> Most of this work is in collaboration with the [Computational Policy Lab](https://policylab.hks.harvard.edu/#projects) at HKS. We build partnerships, develop human-centered AI tools, and evaluate their effectiveness at scale to support teacher training and student learning in developing countries.

2. <span class="research-strand">Education, Prejudice Reduction, and Social Cohesion:</span> I study how schools can serve as sites for social cohesion, particularly around gender and race, and how the norms and preferences shaped by everyday interactions in schools influence people's educational and socioeconomic trajectories.
